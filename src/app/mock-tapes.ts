...
export const TAPES: Tape[] = [
    ...
    { id: 7, title: 'Star Wars: Episode V - The Empire Strikes Back', director: 'George Lucas', year: 1980,price:3.99,status:TapeStatus.RENTED,rating:5,customer: customer},
    { id: 8, title: 'Dead Poets Society', director: 'Peter Weir', year: 1989,price:2.99,status:TapeStatus.RENTED,rating:5,customer: customer2 },
    { id: 9, title: 'Alien', director: 'Ridley Scott', year: 1979,price:2.99,status:TapeStatus.RENTED,rating:5,customer: customer },
    { id: 10, title: 'Star Wars: Episode VI - Return of the Jedi', director: 'George Lucas', year: 1983,price:3.99,status:TapeStatus.RENTED,rating:5,customer: customer },
    { id: 11, title: 'Rocky', director: 'John G. Avildsen', year: 1976 ,price:2.99,status:TapeStatus.RENTED,rating:2,customer: customer2},
