...
describe('AppComponent(templateUrl)', function () {
  ...
  it('should test router link to tapes', () => {
    const  a  =  debA[1].nativeElement;
    fixture.detectChanges();
    expect(a.outerHTML).toContain('"/tapes"');
  });
  it('should test router link to customers', () => {
    const  a  =  debA[2].nativeElement;
    fixture.detectChanges();
    expect(a.outerHTML).toContain('"/customers"');
  });
